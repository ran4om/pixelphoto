...
function convertXML$1(xmlAsString, customConverter) {
    return transpile(xmlAsString, customConverter || jsonConverter)
}

function createAST$1(xmlAsString) {
    return transpile(xmlAsString)
}

var xmlToJson = {
    convertXML: convertXML$1,
    createAST: createAST$1
};

var cjs = /*@__PURE__*/getDefaultExportFromCjs(xmlToJson);

const convertXML = cjs.convertXML;
const createAST = cjs.createAST;
